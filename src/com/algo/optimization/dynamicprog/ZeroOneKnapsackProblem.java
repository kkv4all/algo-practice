...
public class ZeroOneKnapsackProblem {
	...
	public static void main(String[] args) {
		...
		List<ZeroOneKnapsackItem> itemsTaken = fractionalKapsackProblem.dynamicSolution(items,maxBasketCapacity);
	...
	public List<ZeroOneKnapsackItem> dynamicSolution(List<ZeroOneKnapsackItem> knapsackItems, int maxKnapsackCapacity) {
